 ...
 * the OS, so a light panel can hold a dark diagram.
 *
 ...
 * takes its theme at render time.
 *
 * Filament is the authority while this page is open. Truss's own theme button is
 * hidden by the stylesheet, so there is no second control to fight with, and the
 * observer below corrects the attribute if anything else moves it.
 */
(function () {
    ...
    function sync() {
        ...
        // Only when it differs, or setting the attribute would retrigger the
        // observer that called this, and the two would chase each other.
